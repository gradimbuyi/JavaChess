...
public class GameUtils {
    ...
    public static void ParseFenNotation(Tile[][] board) throws FileNotFoundException, InterruptedException {
        Scanner input_file = new Scanner(new File("./src/input/fen_notation.txt"));
        while (input_file.hasNext()) {
            Board.generatePieces(input_file.nextLine());
            produceFEN(board);
            Thread.sleep(150);
        }
    }
